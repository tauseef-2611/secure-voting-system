...
import { DataTableFacetedFilter, DataTableFacetedFilterBool } from "./data-table-faceted-filter"
  ...
  return (
    <div className="flex items-center justify-between">
      <div className="flex flex-1 items-center space-x-2">
        ...
        {table.getColumn("present") && (
          <DataTableFacetedFilterBool
            column={table.getColumn("present")}
            title="Present" options={[]}       />
        )}
        {table.getColumn("voted") && (
          <DataTableFacetedFilterBool
            column={table.getColumn("voted")}
            title="Voted" options={[]}
          />
        )}
        {isFiltered && (
