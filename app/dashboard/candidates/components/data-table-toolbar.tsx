...
import { DataTableFacetedFilter, DataTableFacetedFilterBool, DataTableFacetedFilterVote } from "./data-table-faceted-filter"
  ...
  return (
    <div className="flex items-center justify-between">
      <div className="flex flex-1 items-center space-x-2">
        ...
        {table.getColumn("votes") && (
          <DataTableFacetedFilterVote
            column={table.getColumn("votes")}
            title="Votes"          />
        )}
